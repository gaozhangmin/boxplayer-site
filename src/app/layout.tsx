...
const DESCRIPTION =
  "BoxPlayer 是免费开源的跨平台视频播放器与媒体中心客户端 — iOS 播放器、Apple TV 播放器、macOS / Windows / Linux 桌面播放器,原生支持 Plex、Jellyfin、Emby、Kodi 协议,直连阿里云盘、百度网盘、OneDrive、Google Drive、Dropbox、115 网盘、PikPak、SMB、WebDAV、NFS、FTP,支持 4K HDR10、Dolby Vision 杜比视界、Dolby Atmos 杜比全景声、HDR10+、DTS-HD MA、TrueHD、ISO 原盘、BDMV、UHD 蓝光、MKV / MP4 / TS,适合电影、剧集、动漫、纪录片、家庭影院 NAS 私人影院。";
  ...
  },
  {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "国内云盘:阿里云盘、百度网盘、115 网盘、PikPak;海外云盘:OneDrive、Google Drive、Dropbox、Box;媒体服务器:Plex、Jellyfin、Emby、Kodi;NAS 协议:SMB、WebDAV、NFS、FTP。群晖 Synology、威联通 QNAP、TrueNAS、unRAID 都可以无缝接入。",
        },
      },
      {
        "@type": "Question",
